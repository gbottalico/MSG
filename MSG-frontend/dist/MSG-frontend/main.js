...
var VisitService = /** @class */ (function () {
    ...
    VisitService.prototype.addVisit = function (visit) {
        ...
        return this.http.post(this.visitUrl, visit, httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log("added visit"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError("addVisit")));
    };
